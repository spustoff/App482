        ...
        ZStack {
            ...
            VStack {
                ...
                Button(action: {
                    ...
                    viewModel.favoritesManager(viewModel.selectedOrder)
                    ...
                    Text(viewModel.isFavorited(viewModel.selectedOrder) ? "Completed" : "Complete")
                        .foregroundColor(.white)
                        .font(.system(size: 15, weight: .medium))
                        .frame(maxWidth: .infinity)
                        .frame(height: 50)
...
#Preview {
    DetailOrders2(viewModel: OrdersViewModel())
}
