...
struct AddingOrder: View {
    ...
    var body: some View {
        ...
        ZStack {
            ...
            LinearGradient(colors: [Color.white, Color.white, Color.white, Color("prim").opacity(0.7), Color("prim2")], startPoint: .bottomLeading, endPoint: .topTrailing)
                .ignoresSafeArea()
...
#Preview {
    AddingOrder(viewModel: HomeViewModel())
}
